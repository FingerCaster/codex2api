...
| `CODEX_DISABLE_V1_MESSAGES` | Disable the Anthropic-compatible `/v1/messages` and `/messages` routes at startup; can also be changed at runtime in System Settings |
