...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				api_account_circuit_breaker_enabled INTEGER DEFAULT 1,
				api_account_failure_rate_threshold INTEGER DEFAULT 80,
				api_account_failure_min_samples INTEGER DEFAULT 20,
				api_account_cooldown_minutes INTEGER DEFAULT 2,
				api_account_recovery_probe_interval_minutes INTEGER DEFAULT 1,
				api_account_recovery_probe_successes INTEGER DEFAULT 1,
				api_account_recovery_direct_healthy INTEGER DEFAULT 1,
				api_account_recovery_guard_minutes INTEGER DEFAULT 1,
				session_affinity_ttl_minutes INTEGER DEFAULT 0,
	...
	columns := []struct {
		...
		{"system_settings", "api_account_circuit_breaker_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "api_account_failure_rate_threshold", "INTEGER DEFAULT 80"},
		{"system_settings", "api_account_failure_min_samples", "INTEGER DEFAULT 20"},
		{"system_settings", "api_account_cooldown_minutes", "INTEGER DEFAULT 2"},
		{"system_settings", "api_account_recovery_probe_interval_minutes", "INTEGER DEFAULT 1"},
		{"system_settings", "api_account_recovery_probe_successes", "INTEGER DEFAULT 1"},
		{"system_settings", "api_account_recovery_direct_healthy", "INTEGER DEFAULT 1"},
		{"system_settings", "api_account_recovery_guard_minutes", "INTEGER DEFAULT 1"},
		{"system_settings", "session_affinity_ttl_minutes", "INTEGER DEFAULT 0"},
